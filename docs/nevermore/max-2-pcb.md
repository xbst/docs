...
<img src="../assets/nevermore/Max.jpg" width="600"/>
...
[![Instructions](../assets/nevermore/PCB-Tray.png)](../assets/nevermore/PCB-Tray.png)

## Wiring

All connectors except USB are JST-XH. Use the diagram below to wire your fans, sensors, LEDs, and power.

[![Pinout](../assets/nevermore/Max-Pinout.png)](../assets/nevermore/Max-Pinout.png)
